...
> Free to use, modify, and redistribute under the [MIT License](LICENSE.md).
...
[**MIT**](LICENSE.md). Free to use, copy, modify, merge, publish, distribute,
sublicense, and sell — for any purpose, commercial or not. No strings attached.

> Versions `0.3.0`–`0.3.x` were released under FSL-1.1-MIT. As of `0.4.0` the
> project is **MIT** — the copyright holder (Nuraveda Lab) relicenses it as MIT
> going forward, so anyone can use it, including in a commercial product.

## About

Built and maintained by [Nuraveda Lab](https://nuraveda.com) as open-source tooling.
